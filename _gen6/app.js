(function () {
  ...
  function updateProgress() {
    ...
    if (gate) {
      gate.textContent = readyDone / readyTotal >= 0.85
        ? "You look ready to implement and explain DSA in JavaScript from scratch through expert patterns."
  ...
  function renderMockHistory() {
    ...
    if (!state.mocks.length) {
      el.innerHTML = "<p class='stat-sub'>No mocks yet. Target 8–10 timed problems before calling the course done.</p>";
      return;
    }
  ...
  resetBtn && resetBtn.addEventListener("click", () => {
    if (!confirm("Reset all DSA JavaScript progress on this browser? This cannot be undone.")) return;
